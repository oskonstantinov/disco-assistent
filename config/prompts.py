...
- IMPORTANT: If the input is in a language other than English, translate all dialogue content to the input language. However, XML structure and skill names in XML tags must remain in English.
